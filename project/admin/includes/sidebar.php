...
<div class="col-md-2 sidebar pd0">
	<div class="side_user">
        ...
        <ul>
            ...
            <li><a href="add-office.php"><i class="fa fa-gamepad"></i> Website detail</a>
                <ul>
                  <li><a href="add-product.php"><i class="fa fa-gamepad"></i> Recent Projects </a></li>
                  <li><a href="add-showcase.php"><i class="fa fa-gamepad"></i> Project Showcase </a></li>
                  <li><a href="social-media.php"><i class="fa fa-gamepad"></i> Social Media </a></li>
                </ul>
            </li>
            <li><a href="add-price.php"><i class="fa fa-image"></i> Price Info</a></li>
